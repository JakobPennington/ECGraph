...
import com.jakob.ecgraph.bluno.RingBuffer;
...
public class BluetoothLeService extends Service {
    ...
    public final static String ECG_DATA = "com.example.bluetooth.le.ECG_DATA";
    public final static String DF_ROBOT_DATA = "com.example.bluetooth.le.DF_ROBOT_DATA";
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) {
            if (new String(data).toUpperCase().startsWith("DF BLUNO")){
                intent.putExtra(DF_ROBOT_DATA, new String(data));
            } else {
                intent.putExtra(ECG_DATA, data);
            }
            sendBroadcast(intent);
        }
    }
